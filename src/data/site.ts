...
export type Project = {
  ...
  chapters: string[];    // one short name per sentence after the first
  built: string;
  state: string;
...
const chapterNames: Record<Slug, string[]> = {
  volbase: ['Why I started it', 'Where it is', 'What is next'],
  rin: ['Who it was for', 'Where it is', 'What is left'],
  kyou: ['How it reads a sentence', 'The face at the top', 'Where it is'],
  market: ['Who it is for', 'Where it runs', 'What it looks like'],
};
...
export const copy = {
  ...
  about: [
    ...
    'When I am not building something I climb, mostly bouldering, and I have for six years. I ran varsity cross country before that. I also take a lot of photos, mostly of birds, weather, and buildings, and some of them are in the Photos app on this desktop.',
    'Right now I am applying to college this fall, and I am still fixing things on the four apps above.',
  ],
  done: [
    { name: 'FIRST Robotics', text: 'I started my school\'s FIRST Robotics team and we reached Worlds as a rookie team.' },
    { name: 'Climbing', text: 'I climb, mostly bouldering and some speed, and I have for six years.' },
    { name: 'Cross country', text: 'I ran varsity cross country for two years before that.' },
    { name: 'Volunteering', text: 'I have also spent more than a hundred hours volunteering on a hospital\'s orthopedic wing.' },
  ],
...
export type Stop = { name: string; text: string; state: string; tone: 'blue' | 'green' | 'amber' | 'none'; href?: string; open?: string; origin?: boolean };
export const timeline: Stop[] = [
  { name: 'petermei.com', text: 'This page, and the Mac it is running inside.', state: 'in progress', tone: 'blue', open: 'safari' },
  { name: 'Kyou', text: 'An iPhone planner that puts the whole day on one timeline.', state: 'on its way to the App Store', tone: 'amber', open: 'kyou' },
  { name: 'Market Station', text: 'A dashboard that watches the market all day for one reader at home.', state: 'running since August', tone: 'green', open: 'market' },
  { name: 'Rin', text: 'A Mac app that drops an assistant down from the menu bar.', state: 'free and open source', tone: 'green', href: links.rin, open: 'rin' },
  { name: 'volbase', text: 'A marketplace where students find volunteer and internship openings near them.', state: 'live', tone: 'green', href: links.volbase, open: 'volbase' },
  { name: 'FIRST Robotics', text: 'I started my school\'s FIRST Robotics team with four friends, and we made it to Worlds in our first year.', state: '', tone: 'none', origin: true },
];
